 ...
 * @uses default_admin_header_style()
 * @uses default_admin_header_image()
 */
function default_custom_header_setup() {
    add_theme_support( 'custom-header', apply_filters( 'default_custom_header_args', array(
        ...
        'admin-head-callback'    => 'default_admin_header_style',
        'admin-preview-callback' => 'default_admin_header_image',
    ) ) );
}
...
endif; // default_header_style

if ( ! function_exists( 'default_admin_header_style' ) ) :
/**
...
endif; // default_admin_header_style

if ( ! function_exists( 'default_admin_header_image' ) ) :
/**
...
endif; // default_admin_header_image
